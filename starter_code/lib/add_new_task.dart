...
class _AddNewTaskState extends State<AddNewTask> {
  ...
  // Upload data to "tasks" collection with auto generated id(due to .add)
  Future<void> uploadTaskToDb() async {
    try {
      //Use .add() when you don’t care about the document ID.
      //Use .set() when you want to control the document ID manually.
      final id = const Uuid().v4(); //generates unique id
      final data =
